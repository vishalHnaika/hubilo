/*!
 * jQuery Create image hot link plugin
    ...
    (function ($) {
        ...
        */
        ...
        $.fn.imageMaps = function (options) {
            ...
            // Current hot zone
            let active = null;
            // Coordinates of the current hot zone
            let coords = {
                x1: 0,
                y1: 0,
            ...
            // Set the coordinates of the current hot zone
            ...
            // Support multiple pictures at the same time
            this.each(function (i, item) {
                ...
                $(options.addBtn + ':eq(' + i + ')').unbind('click').on('click', function () {
                    ...
                    let oDiv = $(`<div id="imagemaps-rect-${i}-${index}" style="width:${(coords[2] - coords[0]) || options.rectWidth}px;height:${(coords[3] - coords[1]) || options.rectHeight}px;position:absolute;left:${coords[0] || 0}px;top:${coords[1] || 0}px;background-color:rgba(255,255,255,0.8);border: 1px dashed black;" data-index="${index}">${count}</div>`);
                    _this.append(oDiv);
                    ...
                    // Update hotspot links and opening methods
